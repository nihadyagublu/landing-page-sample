      ...
      <div className="flex-group">
        ...
        >
          <div className="img" with="250px">
            <img with="250px" src={Third} alt="photo" />{" "}
          </div>
        ...
        >
          <div className="img" with="250px">
            <img with="250px" src={Fourth} alt="photo" />{" "}
          </div>
          <b className="mt-3">Separated they live in</b>
          <p>
            Aug 4, 2020 by <span>Admin</span> in <span>Architect</span>
        ...
        >
          <div className="img" with="250px">
            <img with="250px" src={Second} alt="photo" />{" "}
          </div>
          <b className="mt-3">Separated they live in</b>
          <p>
            Aug 4, 2020 by <span>Admin</span> in <span>Architect</span>
        ...
        >
          <div className="img" with="250px">
            <img with="250px" height={"256px"} src={First} alt="photo" />{" "}
          </div>
          <b className="mt-3">Separated they live in</b>
          <p>
            Aug 4, 2020 by <span>Admin</span> in <span>Architect</span>
